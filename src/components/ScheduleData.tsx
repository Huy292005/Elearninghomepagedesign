...
export const getScheduleByRole = (role: string, instructorName?: string): ScheduleSlot[] => {
  if (role === 'tutor' && instructorName) {
    // Nếu là gia sư, chỉ hiển thị các môn mà gia sư đó dạy
    return mockSchedule.filter(slot => slot.instructor === instructorName);
  }
